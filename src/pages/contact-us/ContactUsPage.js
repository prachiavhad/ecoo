        ...
        <main className="dark:bg-gray-800 bg-gray-100 mt-[7%] py-10">
            <div className="container mx-auto p-6 rounded-lg shadow-lg bg-white">
                    ...
                    <div className="border border-primary-200 rounded-lg p-4 shadow-md">
                        ...
                        <p className="text-gray-700 mb-2">
                            ...
                            <Link
                                ...
                                to="mailto:info@ecofarmexchange.com"
                            >
                                info@ecofarmexchange.com
                            </Link>
                        </p>
                    </div>
                    <div className="border border-primary-200 rounded-lg p-4 shadow-md">
                        ...
                        <p className="text-gray-700 mb-2">
                            ...
                            <Link
                                className="text-primary-500 hover:underline"
                                to="mailto:support@ecofarmexchange.com"
                            >
                                support@ecofarmechange.com
                            </Link>
                        </p>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-4">
                    <div className="border border-primary-200 rounded-lg p-4 shadow-md">
                        ...
                        <p className="text-gray-700 mb-2">
                            ...
                            <Link
                                className="text-primary-500 hover:underline"
                                to="mailto:partnerships@ecofarmexchange.com"
                            >
                                partnerships@ecofarmexchange.com
                            </Link>
                        </p>
                    </div>
                    <div className="border border-primary-200 rounded-lg p-4 shadow-md">
                        ...
                        <p className="text-gray-700 mb-2">
                            ...
                            <br />
                            <strong>Ecofarm Exchange Office</strong>
                            <br />
                            123 Organic Lane
                            <br />
                ...
                <div className="mt-6">
                    ...
                    <div className="flex justify-center space-x-4">
                        <Link
                            ...
                            to="https://instagram.com/ecofarmexchange"
                        >
                        ...
                        <Link
                            className="flex items-center text-lg font-bold text-primary-500 hover:underline"
                            to="https://facebook.com/ecofarmexchange"
                        >
                            <FacebookLogo className="text-2xl mr-2" /> Facebook
                        </Link>
                        <Link
                            className="flex items-center text-lg font-bold text-primary-500 hover:underline"
                            to="https://twitter.com/ecofarmexchange"
                        >
                ...
                <p className="text-center text-gray-600 mt-6 text-lg">
                    Thank you for choosing Ecofarm Exchange. We look forward to
                    connecting with you!
                </p>
            </div>
        </main>
