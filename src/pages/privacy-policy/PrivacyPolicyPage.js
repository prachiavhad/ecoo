        ...
        <main className="dark:bg-gray-800 bg-gray-100 mt-[7%] py-10">
            <div className="container mx-auto p-6 rounded-lg shadow-lg bg-white">
                ...
                <p className="text-center text-lg text-gray-600 mb-6">
                    Your privacy is important to us at Ecofarm Exchange.
                </p>
                ...
                <div className="mb-6">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        <Link className="text-primary-500 hover:underline" to="mailto:privacy@swachhharvest.com">
                            privacy@swachhharvest.com
                        </Link>.
                    </p>
                </div>

                <p className="text-center text-gray-700 mb-4">
                    Thank you for trusting SwachhHarvest with your privacy. Your satisfaction and trust are paramount to us.
                </p>
                <p className="text-center text-gray-700 mb-4">
                    Sincerely,<br />
                    The SwachhHarvest Team
                </p>
            </div>
        </main>
    );
