  ...
  return (
    <main className='dark:bg-gray-800 bg-gray-100 mt-[6%] py-10'>
        <div className='container my-7 mx-auto p-6 rounded-lg shadow-lg bg-white'>
            <h1 className='text-4xl text-center text-primary-500 font-bold mb-4'>About Ecofarm Exchange</h1>

            <p className='text-lg text-gray-700 mb-6'>
                Welcome to Ecofarm Exchange - your all-in-one platform for organic farming! We are committed to empowering farmers with the best tools, resources, and knowledge to thrive in sustainable agriculture.
            </p>

            <h2 className="text-2xl text-primary-400 font-semibold mb-2">Our Mission</h2>
            <p className='text-lg text-gray-700 mb-6'>
                At Ecofarm Exchange, our mission is to promote organic farming practices that enrich the soil, produce healthy crops, and support eco-friendly initiatives. We strive to deliver exceptional resources and foster a community of sustainable farmers.
            </p>
            ...
            <p className='text-lg text-gray-700 mb-6'>
                The V team comprises passionate individuals dedicated to promoting organic farming. We are constantly exploring innovative practices and sharing our insights to help you grow sustainably.
            </p>
            ...
            <p className='text-lg text-gray-700 mb-6'>
                ...
                <Link className='text-primary-500 hover:underline' to='mailto:info@ecofarmechange.com'> info@ecofarmechange.com</Link>. Our team is ready to assist you on your organic farming journey.
            </p>

            <p className='text-lg text-gray-700'>
                Thank you for choosing Ecofarm Exchange as your trusted partner in organic farming. Together, let's cultivate a greener future!
                <br />
                Happy Farming,
                <br />
