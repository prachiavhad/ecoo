        ...
        <main className="dark:bg-gray-800 bg-gray-100 mt-[6%] py-10">
            <div className="container my-7 mx-auto p-6 rounded-lg shadow-lg bg-white">
                ...
                <p className="text-lg text-gray-700 mb-6">
                    Welcome to Ecofarm Exchange! By accessing and using our website or services, you agree to comply with the following terms and conditions. Please read these terms carefully before proceeding.
                </p>
                ...
                <p className="text-lg text-gray-700 mb-4">
                    All content on our website, including images, text, logos, and trademarks, is the intellectual property of Ecofarm Exchange or its licensors. You may not use, reproduce, or distribute any content without prior written permission.
                </p>
                ...
                <p className="text-lg text-gray-700 mb-4">
                    Ecofarm Exchange shall not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from your use of our website or services, including but not limited to loss of data, revenue, or profits.
                </p>
                ...
                <p className="text-lg text-gray-700 mb-4">
                    Ecofarm Exchange reserves the right to modify or update these terms and conditions at any time. Changes will be effective immediately upon posting on our website. Continued use of our services constitutes acceptance of the revised terms.
                </p>
                ...
                <p className="text-lg text-gray-700 mb-4">
                    ...
                    <Link className="text-primary-500 hover:underline" to="mailto:legal@ecofarmexchange.com">
                        legal@ecofarmexchange.com
                    </Link>.
                </p>

                <p className="text-lg text-gray-700">
                    Thank you for choosing Ecofarm Exchange. We look forward to serving you with excellence and integrity.
                    <br />
                    Sincerely,
                    <br />
                    The Ecofarm Exchange Team
                </p>
            </div>
        </main>
    );
